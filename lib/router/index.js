...
Router.prototype.route = function(req, res) {
  ...
  console.log('Handling virtual request :: Running virtual querystring parser...');
  qsParser(req,res, function (err) {
    ...
    parseCookies(req, res, function(err){
      ...
      loadSession(req, res, function (err) {
        ...
        console.log('Handling virtual request :: Running virtual body parser...');
        bodyParser(req,res, function (err) {
          ...
          _privateRouter.router(req, res, function handleUnmatchedNext(err) {
            ...
            if (err) {
              console.log('Handling virtual request :: Running final "error" handler...');
              sails.emit('router:request:500', err, req, res);
              return;
            }

            // Or the default not found handler
            console.log('Handling virtual request :: Running final "not found" handler...');
